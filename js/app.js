...
const restartGame = () => {
    while (boardDiv === null || boardDiv === void 0 ? void 0 : boardDiv.firstChild) {
...
const displayBoard = () => {
    ...
    board.map((row, rI) => {
        ...
        boardDiv === null || boardDiv === void 0 ? void 0 : boardDiv.appendChild(rowDiv);
        const cells = row.map((cell, cI) => {
            const cellDiv = document.createElement('div');
            cellDiv.classList.add('cell');
            cellDiv.addEventListener('click', () => cellClickHandler(cellDiv, board, rI, cI));
...
const cellClickHandler = (cellDiv, board, rI, cI) => {
